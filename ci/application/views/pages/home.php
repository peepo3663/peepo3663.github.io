...
<div id="wrapper">
      ...
      <!-- Header -->
        <section id="header" class="skel-layers-fixed">
          <header>
            <span class="image avatar"><img src="images/me.jpg" alt="My Profile Picture" /></span>
            <h1 id="logo"><a href="#">Wasupol Tungsakultong</a></h1>
            <p>I am Software Developer from Kasetsart University<br />
            and I love JAVA Programming</p>
          </header>
          <nav id="nav">
            <ul>
